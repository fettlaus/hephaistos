...
#define BYTEPTR(x)			((uint8_t*)&(x))		// converts x to a UINT8* for bytewise access ala x[foo]
...
#define MS_TO_CORE_TICKS(x) MS2ST(x)
#define CT_TICKS_SINCE(tick) (chTimeNow() - (tick))								// number of core timer ticks since "tick"

// Transceiver Configuration

#define MAX_SPI_CLK_FREQ           	(10e6)		// Seems to match Table 5-5 of MRF24J20 datasheet
/*
#define RFIFu            	IFS0bits.INT4IF		// interrupt input to PIC32
