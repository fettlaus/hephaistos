...
#define GPIOE_SPI1_NSS              12
#define GPIOE_SPI1_SCK              13
#define GPIOE_SPI1_MISO             14
#define GPIOE_SPI1_MOSI             15
 ...
 * PB6  - LED4                      (input pullup).
 * PB7  - LED3                      (input pullup).
...
#define VAL_GPIOB_OSPEEDR           (PIN_OSPEED_400K(GPIOB_PIN0) |          \
                                     ...
                                     PIN_OSPEED_40M(GPIOB_UART3_TX) |         \
                                     PIN_OSPEED_40M(GPIOB_UART3_RX) |         \
 ...
 * PE10 - GPIOE_LED1    			(output push-pull).
 * PE11 - GPIOE_LED2    			(output push-pull).
 * PE12 - GPIOE_SPI1_NSS            (output push-pull).
 * PE13 - GPIOE_SPI1_SCK            (alternate 5).
 * PE14 - GPIOE_SPI1_MISO           (alternate 5).
 * PE15 - GPIOE_SPI1_MOSI           (alternate 5).
 */
#define VAL_GPIOE_MODER             (PIN_MODE_INPUT(GPIOE_PIN0) |           \
                                     ...
                                     PIN_MODE_OUTPUT(GPIOE_SPI1_NSS) |          \
                                     PIN_MODE_INPUT(GPIOE_SPI1_SCK) |          \
                                     PIN_MODE_INPUT(GPIOE_SPI1_MISO) |          \
                                     PIN_MODE_INPUT(GPIOE_SPI1_MOSI))
#define VAL_GPIOE_OTYPER            (PIN_OTYPE_PUSHPULL(GPIOE_PIN0) |       \
                                     ...
                                     PIN_OTYPE_PUSHPULL(GPIOE_SPI1_NSS) |      \
                                     PIN_OTYPE_PUSHPULL(GPIOE_SPI1_SCK) |      \
                                     PIN_OTYPE_PUSHPULL(GPIOE_SPI1_MISO) |      \
                                     PIN_OTYPE_PUSHPULL(GPIOE_SPI1_MOSI))
#define VAL_GPIOE_OSPEEDR           (PIN_OSPEED_400K(GPIOE_PIN0) |          \
                                     ...
                                     PIN_OSPEED_40M(GPIOE_LED1) |         \
                                     PIN_OSPEED_40M(GPIOE_LED2) |         \
                                     PIN_OSPEED_40M(GPIOE_SPI1_NSS) |         \
                                     PIN_OSPEED_40M(GPIOE_SPI1_SCK) |         \
                                     PIN_OSPEED_400K(GPIOE_SPI1_MISO) |         \
                                     PIN_OSPEED_40M(GPIOE_SPI1_MOSI))
#define VAL_GPIOE_PUPDR             (PIN_PUPDR_PULLUP(GPIOE_PIN0) |         \
                                     ...
                                     PIN_PUPDR_PULLUP(GPIOE_SPI1_NSS) |        \
                                     PIN_PUPDR_PULLUP(GPIOE_SPI1_SCK) |        \
                                     PIN_PUPDR_PULLUP(GPIOE_SPI1_MISO) |        \
                                     PIN_PUPDR_PULLUP(GPIOE_SPI1_MOSI))
#define VAL_GPIOE_ODR               (PIN_ODR_HIGH(GPIOE_PIN0) |             \
                                     ...
                                     PIN_ODR_HIGH(GPIOE_LED1) |            \
                                     PIN_ODR_LOW(GPIOE_LED2) |            \
                                     PIN_ODR_HIGH(GPIOE_SPI1_NSS) |            \
                                     PIN_ODR_HIGH(GPIOE_SPI1_SCK) |            \
                                     PIN_ODR_HIGH(GPIOE_SPI1_MISO) |            \
                                     PIN_ODR_HIGH(GPIOE_SPI1_MOSI))
...
#define VAL_GPIOE_AFRH              (PIN_AFIO_AF(GPIOE_PIN8, 0) |           \
                                     ...
                                     PIN_AFIO_AF(GPIOE_LED1, 0) |          \
                                     PIN_AFIO_AF(GPIOE_LED2, 0) |          \
                                     PIN_AFIO_AF(GPIOE_SPI1_NSS, 0) |          \
                                     PIN_AFIO_AF(GPIOE_SPI1_SCK, 5) |          \
                                     PIN_AFIO_AF(GPIOE_SPI1_MISO, 5) |          \
                                     PIN_AFIO_AF(GPIOE_SPI1_MOSI, 5))
